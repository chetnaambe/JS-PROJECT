...
let one = {
    sayName:function() {  //iska parent poora object 
      console.log(this);
    },
sayArrowName: ()=>{  //parent hai object or ye global scope me bana hai to window
console.log(this);
}
}
